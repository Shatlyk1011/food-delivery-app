...
import { useCreateFeedbackOrCoop } from "@/services/useFeedbackAndCoop";

//components
import Spinner from "@/components/shared-ui/Spinner";
const CooperationModal = dynamic(() => import("@/components/footer-ui/CooperationModal"), {
  loading: () => <Spinner />,
});

const FeedbackModal = dynamic(() => import("@/components/footer-ui/FeedbackModal"), {
  loading: () => <Spinner />,
});
