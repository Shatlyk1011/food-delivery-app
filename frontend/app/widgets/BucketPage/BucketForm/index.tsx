...
//components
const BucketFormComponent = dynamic(() => import("@/components/bucket-page-ui/BucketForm/Form"), { ssr: false });
import DeliveryItem from "@/components/shared-ui/DeliveryItem";
