...
//services
import { useGetCategories } from "@/services/useCategories";
import { useGetRestaurantsQuery } from "@/services/useRestaurants";

import { defaultFilters } from "@/data";

//components
import RestaurantItemSkeleton from "@/widgets/RestaurantItem/Skeleton";
import RestaurantItem from "@/widgets/RestaurantItem";
