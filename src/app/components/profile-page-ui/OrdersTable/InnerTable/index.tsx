  ...
  return (
    <div className=" px-8 last:pb-6">
      ...
      <div className="flex flex-col">
        <ul className="flex w-[40%] border-b border-black/20 text-sm font-medium text-black/85 md:text-xs xl:w-[60%] [&>*]:px-4 [&>*]:py-3 xl:[&>*]:px-3 xl:[&>*]:py-2">
        ...
        {dishes?.map(({ dish: { price, title }, quantity }, i) => (
          <ul
            key={i}
            className="flex w-[40%] items-center border-b border-black/20 text-sm md:text-xs xl:w-[60%] xl:text-sm [&>*]:px-4 [&>*]:py-2 xl:[&>*]:px-3"
          >
